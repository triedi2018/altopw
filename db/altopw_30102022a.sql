...
CREATE TABLE `data_cuti` (
  ...
  UNIQUE KEY `nik` (`nik`,`tahun`) USING BTREE
...
CREATE TABLE `data_pelanggan` (
  ...
  `status_ref` varchar(45) DEFAULT NULL,
  `no_npwp` varchar(60) DEFAULT NULL,
  `faktur_pajak` varchar(45) DEFAULT NULL,
...
DROP TABLE IF EXISTS `jabatan_divisi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `pengajuan_cuti` (
  ...
  PRIMARY KEY (`id`,`nomor`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proforma_invoices` (
  ...
  `cust_order_no` varchar(80) DEFAULT NULL,
  ...
  `pph22` double DEFAULT NULL,
  `pph23` double DEFAULT NULL,
  `sktd` double DEFAULT NULL,
  `fee` double DEFAULT NULL,
  `total` double DEFAULT NULL,
  `paid` double DEFAULT NULL,
  `paid_date` date DEFAULT NULL,
  `outstading` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `tgl_libur_nasional`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2022-10-30 19:20:36
