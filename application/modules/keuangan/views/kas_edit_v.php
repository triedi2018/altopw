		...
		<input type="hidden" name="id" value="<?= md5($data['id']) ?>" />
			...
			<div class="form-group">
			  <label class="control-label">
				Tanggal Transaksi <span class="symbol required"> </span>
			  </label>
			  <div class="input-group input-append datepicker date" data-date-format='dd-mm-yyyy' style="padding: 0px;" > 
				<input class="form-control" type="text" readonly autocomplete="off" name="tanggal" value="<?= date("d-m-Y", strtotime($data['tanggal'])) ?>" required />
			...
			<div class="form-group">
			  <label>Jenis Transaksi <span class="symbol required"> </span></label>
			  <select class="form-control" id="list_transaksi" name="jenis_transaksi">
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <textarea rows="3" name="keterangan" required class="form-control" placeholder="Keterangan"><?= $data['keterangan'] ?></textarea>
              </div>
            </div>			
