...
class Komisi extends CI_Controller {
    public function __construct(){
        parent::__construct();
        $this->load->model('Komisi_m','Data_model');
        cek_aktif_login();
        cek_akses_user();
    }
    ...
    public function tambah(){
        ...
        $this->load->view('komisi_tambah_v');
    }
    ...
    public function edit(){
        ...
        if (cek_akses_user()['edit'] == 0){
            ...
            $this->load->view('komisi_edit_v',$data);
    ...
    public function tampildata()
	{
		...
		foreach ($list as $data) {
            ...
            $row = ['nama' => $data['nama'] ,'keterangan' => $data['keterangan'] ,'jumlah' => rupiah($data['jumlah']),'tanggal'=>date("d-m-Y", strtotime($data['tanggal'])),
