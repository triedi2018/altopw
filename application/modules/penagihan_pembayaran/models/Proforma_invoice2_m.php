...
class Proforma_invoice2_m extends CI_Model {
    ...
    var $table = '( select a.* , b.nama_pelanggan, c.nama_produk from vw_surat_jalan_items a left join data_pelanggan b on a.customer_id = b.id left join data_produk c on a.description_name = c.id ) u';
	...
	var $order = array('u.customer_id' => 'ASC'); // default order 
