...
class Barang_masuk extends CI_Controller {
    public function __construct(){
        parent::__construct();
        $this->load->model('Barang_masuk_m','Data_model');
        cek_aktif_login();
        cek_akses_user();
    }
    ...
    public function index(){
        ...
        $this->load->view('barang_masuk_js');
        //========= end
    ...
    public function tampildata()
	{
		...
		foreach ($list as $data) {
            ...
            $row = ['nama_produk' => $data['nama_produk'] ,'jumlah' => $data['jumlah'],'tanggal_masuk'=>date("d-m-Y", strtotime($data['tanggal_masuk'])),
