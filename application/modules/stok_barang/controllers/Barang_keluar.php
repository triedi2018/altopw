...
class Barang_keluar extends CI_Controller {
    public function __construct(){
        parent::__construct();
        $this->load->model('Barang_keluar_m','Data_model');
        cek_aktif_login();
        cek_akses_user();
    }
    ...
    public function index(){
        ...
        $this->load->view('barang_keluar_v',$data);
        
        $this->load->view('templates/footer-top');
        // js for this page only
        $this->load->view('barang_keluar_js');
        //========= end
    ...
    public function tampildata()
	{
		...
		foreach ($list as $data) {
            ...
            $row = [
			'nama_produk' => $data['nama_produk'] ,'jumlah' => $data['jumlah'],'harga' => rupiah($data['harga']),'no_surat_jalan' => $data['no_surat_jalan'],'tanggal_surat_jalan' => date("d-m-Y", strtotime($data['tanggal_surat_jalan'])),
