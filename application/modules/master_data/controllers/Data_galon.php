...
class Data_galon extends CI_Controller {
    public function __construct(){
        parent::__construct();
        $this->load->model('Data_galon_m','Data_model');
        cek_aktif_login();
        cek_akses_user();
    }
    ...
    public function index(){
        ...
        $this->load->view('data_galon_v',$data);
        
        $this->load->view('templates/footer-top');
        // js for this page only
        $this->load->view('data_galon_js');
        //========= end
    ...
    public function tambah(){
        ...
        $this->load->view('data_galon_tambah_v');
    }
    ...
    public function edit(){
        ...
        if (cek_akses_user()['edit'] == 0){
            ...
            $this->load->view('data_galon_edit_v',$data);
