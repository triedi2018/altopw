		...
		<input type="hidden" name="id" value="<?= md5($data['id']) ?>" />
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" autocomplete="off" name="kode" value="<?= $data['kode'] ?>" required class="form-control" placeholder="Kode">
              </div>
            </div>	
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" autocomplete="off" name="kode_pelanggan" value="<?= $data['kode_pelanggan'] ?>" required class="form-control" placeholder="Kode Pelanggan">
              </div>
            </div>	
